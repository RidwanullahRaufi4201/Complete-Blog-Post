    ...
    <div id="content">
        ...
        <div class="container-fluid">
            ...
            <div class="card">
                ...
                <form action="{{route('post.update',['post'=>$post->id])}}" method="post" class="w-75 mx-auto" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                          <div class="form-group">
                                      <label for="" class="fw-bolder">Title</label>
                                      <input type="text" name="title"  value="{{$post->title}}" class="form-control form-control-sm">
                                      @error('title')
                                          <p class="text-danger">
                                              {{ $message }}
                                          </p>
                          ...
                          <div class="form-group">
                            ...
                            <input type="text"   value="{{$post->subtitle}}" name="subtitle" class="form-control form-control-sm">
                            @error('subtitle')
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control form-control-sm my-editor" name="description">
                        {{$post->description}}
                    </textarea>
                    @error('description')
                        <p class="text-danger">{{$message}}</p>
